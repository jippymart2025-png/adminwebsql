    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(".edit-setting-btn").click(function () {
                ...
                database.collection('settings').doc("CODSettings").update({'isEnabled': isCODEnabled}).then(async function (result) {
                    // Log the activity
                    await logActivity('payment_methods', 'updated', 'Updated COD payment settings: Enabled=' + (isCODEnabled ? 'Yes' : 'No'));
