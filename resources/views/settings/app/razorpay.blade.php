    ...
    $(document).ready(function () {
        ...
        $(".edit-setting-btn").click(function () {
            ...
            database.collection('settings').doc("razorpaySettings").update({
                ...
                // Log the activity
                await logActivity('payment_methods', 'updated', 'Updated Razorpay payment settings: Enabled=' + (isRazorpayenabled ? 'Yes' : 'No') + ', Sandbox=' + (sendboxmode ? 'Yes' : 'No') + ', Withdraw=' + (isWithdrawEnabled ? 'Enabled' : 'Disabled'));
