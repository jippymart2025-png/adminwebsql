...
class BannerPermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Define banners permissions
        $bannerPermissions = [
            'banners' => ['banners', 'banners.create', 'banners.edit', 'banners.delete']
        ];
        
        $addedCount = 0;
        
        foreach ($bannerPermissions as $permission => $routes) {
        ...
        $this->command->info('Successfully added ' . $addedCount . ' banners permissions to Super Administrator role!');
    }
}
